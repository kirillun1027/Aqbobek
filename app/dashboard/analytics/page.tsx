...
export default function AnalyticsPage() {
  ...
  useEffect(() => {
    async function loadData() {
      const [students, grades, achievements, overview] = await Promise.all([
        getStudentsFromBackend(),
        getAllGradesFromBackend(),
        getAllAchievementsFromBackend(),
        getAnalyticsOverviewFromBackend(),
      ...
      setStats({
        students: overview.total_students || students.length,
        teachers: overview.total_teachers,
        avgScore,
        achievements: overview.total_achievements || achievements.length,
      })
